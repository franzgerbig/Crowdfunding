...
st.set_page_config(
    ...
    # page_icon=r"C:\Users\bosse\Desktop\Notebooks\Streamlit\Final\Kickstarter_logo.png",
...
# ,'Original Modelling' Seite entfernt
...
if page==pages[0]:
    ...
    # image=Image.open(r'C:\Users\bosse\Desktop\Notebooks\Streamlit\Final\Kickstarter_logo_green.png')
    st.image(image)
...
if page==pages[3]:
    ...
    countries=pd.read_csv(r'C:\Users\bosse\Desktop\Notebooks\Streamlit\Final\countries.csv')
...
if page==pages[5]:   
    ...
    # image loading
    image=Image.open(r'C:\Users\bosse\Desktop\Notebooks\Streamlit\Final\Results_2.png')
    st.image(image)
############# Results ####################################################################
if page==pages[6]:
    st.title(pages[6])
